import {useLazyGetUserReposLQuery, useSearchUsersQuery} from "../store/github/github.api";
...
const HomePage = () => {
    ...
    const [fetchRepos,{isLoading:areReposLoading,isError:isErrorRepos,data:repos}] = useLazyGetUserReposLQuery()
    useEffect(() => {
